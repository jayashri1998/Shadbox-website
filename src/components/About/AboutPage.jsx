const AboutUs = () => {
    return (
      <div>
        <section className="bg-center bg-no-repeat bg-[url('https://images.pexels.com/photos/4985341/pexels-photo-4985341.jpeg')] bg-gray-700 bg-blend-multiply">
          <div className="px-4 mx-auto max-w-screen-xl text-center py-32 lg:py-56">
            <h1 className="mb-4 text-2xl font-roboto font-bold tracking-tight leading-none text-white md:text-3xl lg:text-4xl">
              Accomplish Your Goals
            </h1>
            <p className="mb-8 font-poppins text-justify text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">
            <span className="underline decoration-[#2563EB] underline-offset-4">
              Shad<span className="text-[#2563EB]">Box</span>
            </span> Infosystem is committed to getting projects completed
              efficiently. If you have an app or web-based idea you want to
              develop, we can make it happen. No matter how complex your project,
              we will find the optimal solution and deliver it on time. Our focus
              is on accomplishing goals and bringing ideas to fruition.
            </p>
          </div>
        </section>
        <div className="flex flex-col md:flex-row">
          <div className="max-w-3xl my-10 mx-10">
            ...
            <p className="text-lg leading-7 text-justify text-gray-600 my-4"><span className=" text-black underline decoration-[#2563EB] underline-offset-4">
              Shad<span className="text-[#2563EB]">Box</span>
            </span> Infosystem is an IT firm specializing in web development, mobile application development, and custom software solutions. With a dedicated team of developers, Shadbox has a proven track record of delivering high-quality products on time.</p>
            <p className="text-lg leading-7 text-justify text-gray-600 my-4">Since it&#39;s inception, businesses have trusted Shadbox to translate their ideas into functional software and user-friendly applications. Their expertise covers the latest programming languages and development tools, enabling them to build customized solutions tailored to each client&#39;s unique needs. From concept to launch, Shadbox&#39;s collaborative approach keeps clients involved during each project milestone. Their focus on meeting deadlines, combined with robust testing and QA practices, ensures a smooth deployment every time. When you partner with Shadbox, you get more than just engineers - you get a passionate team committed to your project&#39;s success.</p>
          </div>
