const TechStack = () => {
    return (
      <div className=" max-w-screen-xl mx-auto my-10 text-center">
        <h1 className="font-roboto font-semibold text-3xl tracking-wide my-8">
          Technology Stack
        </h1>
        <div className="flex flex-col flex-wrap md:flex-row items-center gap-6 justify-center lg:justify-around mx-6">
          <div className="bg-[#F1EFEF] px-2 py-3 w-24 rounded-xl  text-center">
            <svg
            ...
            <h3 className="font-roboto font-medium mt-2">HTML</h3>
          </div>
          <div className="bg-[#F1EFEF] px-2 py-3 w-24 rounded-xl  text-center">
            <svg
              className="w-16 h-16 mx-auto"
            ...
            <h3 className="font-roboto font-medium mt-2">CSS</h3>
          </div>
          <div className="bg-[#F1EFEF] px-2 py-3 w-24 rounded-xl  text-center">
            <svg
              className="w-16 h-16 mx-auto"
            ...
            <h3 className="font-roboto font-medium mt-2">JavaScript</h3>
          </div>
          <div className="bg-[#F1EFEF] px-2 py-3 w-24 rounded-xl  text-center">
            <svg
              className="w-16 h-16 mx-auto"
            ...
            <h3 className="font-roboto font-medium mt-2">Ruby</h3>
          </div>
          <div className="bg-[#F1EFEF] px-2 py-3 w-24 rounded-xl  text-center">
            <svg
              className="w-16 h-16 mx-auto"
            ...
            <h3 className="font-roboto font-medium mt-2">RoR</h3>
          </div>
          <div className="bg-[#F1EFEF] px-2 py-3 w-24 rounded-xl  text-center">
            <svg
              className="w-16 h-16 mx-auto"
            ...
            <h3 className="font-roboto font-medium mt-2">ReactJS</h3>
          </div>
          <div className="bg-[#F1EFEF] px-2 py-3 w-24 rounded-xl  text-center">
            
  <svg  className="w-16 h-16 mx-auto" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
