    ...
    <div className="max-w-lg md:max-w-2xl mx-3 md:mx-auto mt-20">
      ...
      <div className="flex items-center gap-5 my-4">
        <div className="flex items-center gap-2">
          ...
          <h4 className="font-roboto text-gray-500 ">{blogData.author_name}</h4>
        </div>
        <h4 className="font-roboto text-gray-500 ">{new Date(blogData.created_at).toLocaleDateString()}</h4>
      </div>
      <div className="my-5">
        <img
          src={blogData.inside_image_url}
          alt="blog"
      ...
      <div className="font-poppins leading-7">
        ...
        {/* Comment Section */}
      <CommentSection commentData={data[0].comments}/>
      </div>
    </div>
  );
};
